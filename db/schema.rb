...
ActiveRecord::Schema.define(version: 20151025125207) do
  ...
  create_table "kid_scores", force: :cascade do |t|
    t.string   "name"
    t.integer  "score"
  ...
  add_index "kid_scores", ["user_id"], name: "index_kid_scores_on_user_id", using: :btree
  ...
  add_foreign_key "kid_scores", "users"
